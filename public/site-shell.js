...
splash.innerHTML='<div class="mcq-splash-bg" aria-hidden="true"></div><div class="mcq-splash-shade" aria-hidden="true"></div><div class="mcq-splash-frame"><div class="mcq-splash-top"><a href="/" class="mcq-splash-logo" aria-label="MCQ Audio home"><strong>MCQ</strong><span>AUDIO</span></a><span>REAL PEOPLE · REAL SOUND · A BRIGHTER TOMORROW</span></div><div class="mcq-splash-copy"><p class="mcq-splash-brush">GEAR <em>FUELS</em> CULTURE</p><div class="mcq-splash-brand"><h1>MCQ <span>AUDIO</span></h1><h2>Professional Sound.<br>Music Culture.<br>Real Equipment.</h2><div class="mcq-splash-goldline"></div><p class="mcq-splash-years">55 YEARS OF REAL SOUND</p><p class="mcq-splash-about">Shop the gear that powers DJs, studios, venues and collectors.</p><a href="/shop" class="mcq-splash-enter">SHOP ALL GEAR <b>→</b></a></div></div><nav class="mcq-splash-links" aria-label="Explore MCQ"><a href="/shop"><span class="mcq-icon">◉</span><b>SHOP AUDIO</b><small>Real equipment</small></a><a href="/dj"><span class="mcq-icon">◎</span><b>DJ GEAR</b><small>Controllers & decks</small></a><a href="/featured"><span class="mcq-icon">▣</span><b>STUDIO</b><small>Monitors & recording</small></a><a href="/hire"><span class="mcq-icon">▥</span><b>LIVE SOUND</b><small>PA hire & install</small></a><a href="/vinyl"><span class="mcq-icon">●</span><b>VINYL</b><small>Records & white labels</small></a><a href="/swap"><span class="mcq-icon">⌁</span><b>SWAP SHOP</b><small>Buy · sell · trade</small></a></nav><div class="mcq-splash-footer"><span>MUSIC CREATES A BRIGHTER TOMORROW.</span><button type="button" class="mcq-splash-skip">ENTER SITE</button></div></div>';
...
splash.querySelector(".mcq-splash-skip")?.addEventListener("click",closeSplash);
};
