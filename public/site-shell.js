...
splash.innerHTML='<div class="mcq-splash-noise"></div><div class="mcq-splash-inner"><div class="mcq-splash-logo-wrap"><img src="/favicon.svg" alt="" class="mcq-splash-logo"><div class="mcq-splash-mark">MCQ<span>AUDIO</span></div></div><div class="mcq-splash-rule"></div><p class="mcq-splash-legacy">55 YEARS OF REAL SOUND</p><h1>PROFESSIONAL AUDIO • DJ • HI-FI</h1><p class="mcq-splash-about">Shop audio equipment, DJ gear, microphones, speakers and specialist parts. PA hire, installation, vinyl and hard-to-find sourcing from MCQ Entertainments.</p><div class="mcq-splash-tags" aria-label="MCQ services"><span>SHOP AUDIO</span><span>DJ GEAR</span><span>PA HIRE</span><span>VINYL</span><span>INSTALL</span></div><div class="mcq-splash-bars" aria-hidden="true"><i></i><i></i><i></i><i></i><i></i><i></i><i></i><i></i></div><button type="button" class="mcq-splash-enter">ENTER MCQ AUDIO</button></div>';
