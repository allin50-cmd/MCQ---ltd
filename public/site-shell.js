...
splash.innerHTML='<div class="mcq-splash-inner"><div class="mcq-splash-wordmark" aria-label="MCQ Audio"><strong>MCQ</strong><span>AUDIO</span></div><p class="mcq-splash-legacy">55 YEARS OF REAL SOUND</p><h1>PROFESSIONAL AUDIO • DJ • HI-FI</h1><p class="mcq-splash-about">Audio equipment, DJ gear, microphones, speakers, specialist parts, PA hire and installation.</p><div class="mcq-splash-services" aria-label="MCQ services"><span>SHOP AUDIO</span><span>DJ EQUIPMENT</span><span>PA HIRE</span><span>INSTALLATION</span><span>VINYL & SPECIALIST SOURCING</span></div><button type="button" class="mcq-splash-enter">ENTER MCQ AUDIO</button></div>';
...
splash.querySelector(".mcq-splash-enter")?.addEventListener("click",closeSplash);
};
