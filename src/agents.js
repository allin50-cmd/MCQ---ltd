export const MCQ_AGENTS=Object.freeze([
  ...
  {id:"research",name:"Research Agent",role:"Reviews market, competitor and public business-prospect evidence; prepares sourced prospect candidates without contacting them",mode:"READ_RECOMMEND"},
  ...
  {id:"sales",name:"Sales Agent",role:"Qualifies real sales leads and approved prospect candidates; prepares contact options and follow-up drafts without autonomous outreach",mode:"CRM_ASSIST"},
  {id:"hire",name:"Hire Agent",role:"Works real PA hire enquiries and booking readiness",mode:"CRM_ASSIST"},
  {id:"trade",name:"Trade Agent",role:"Works real B2B and venue opportunities; scores sourced public-business prospects for trade, hire and installation fit",mode:"CRM_ASSIST"},
