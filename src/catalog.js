...
const CATALOG = [
  ...
  {id:"sony-whch720n",brand:"Sony",name:"WH-CH720N",category:"headphones",price_band:"entry",image:"",summary:"Lightweight everyday wireless ANC headphones with multipoint and long battery life.",specs:["ANC","Multipoint","DSEE","Up to 35h"]},
  {id:"technics-sl1200g",brand:"Technics",name:"SL-1200G",category:"turntables",price_band:"premium",image:"https://panasonic.scene7.com/is/image/Panasonic/ast-1651355-25?fmt=png-alpha&hei=644&wid=644",summary:"Grand Class direct-drive turntable with coreless motor and magnesium tonearm.",specs:["Direct drive","33/45/78 rpm","0.025% W&F","Approx 18 kg"]},
  {id:"technics-sur1000",brand:"Technics",name:"SU-R1000",category:"amplifiers",price_band:"premium",image:"https://panasonic.scene7.com/is/image/Panasonic/ast-1263320-29?fmt=png-alpha&hei=644&wid=644",summary:"Reference Class integrated amplifier with digital architecture and serious phono support.",specs:["150W/ch 8Ω","300W/ch 4Ω","MM/MC phono","USB + XLR"]},
  {id:"technics-sccx700",brand:"Technics",name:"SC-CX700",category:"wireless",price_band:"premium",image:"",summary:"Active wireless hi-fi system with streaming, phono, HDMI ARC and room adjustment.",specs:["200W total","Phono MM","HDMI ARC","Space Tune"]},
  ...
  {id:"shure-beta58a",brand:"Shure",name:"Beta 58A",category:"microphones",price_band:"mid",image:"",summary:"Higher-output supercardioid dynamic vocal microphone.",specs:["Dynamic","Supercardioid","Live vocal","High output"]},
  {id:"shure-glxd24r",brand:"Shure",name:"GLXD24R+/SM58",category:"microphones",price_band:"premium",image:"",summary:"Digital wireless rack system with SM58 handheld transmitter.",specs:["Digital wireless","Dual band","Rechargeable","Rack receiver"]},
  ...
  {id:"alphatheta-omnisduo",brand:"AlphaTheta",name:"OMNIS-DUO",category:"dj",price_band:"mid",image:"",summary:"Portable battery-powered all-in-one DJ system.",specs:["Standalone","Battery","7-inch screen","Bluetooth I/O"]},
  {id:"sony-ultfield1",brand:"Sony",name:"ULT FIELD 1",category:"wireless",price_band:"entry",image:"https://sony.scene7.com/is/image/sonyglobalsolutions/00-13?%24large360ViewerImage%24=",summary:"Compact portable Bluetooth speaker with IP67 protection.",specs:["IP67","Bluetooth","12h","Portable"]},
